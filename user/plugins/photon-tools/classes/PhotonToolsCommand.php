 ...
 */
class PhotonToolsCommand extends ConsoleCommand
{
        ...
        if (isset($source_theme)) {
            ...
            if ($type != 'blueprint') {
                ...
                rename(
                  ...
                  $component_folder . DS . 'assets' . DS . $folder_name . '.css');
                rename(
                  $component_folder . DS . 'assets' . DS . $type . '.js',
                  $component_folder . DS . 'assets' . DS . $folder_name . '.js');
                rename(
                  $component_folder . DS . 'blueprints' . DS . $type . '.yaml',
                  $component_folder . DS . 'blueprints' . DS . $folder_name . '.yaml');
                rename(
                  $component_folder . DS . 'templates' . DS . $type . '.html.twig',
                  $component_folder . DS . 'templates' . DS . $folder_name . '.html.twig');
                rename(
